...
namespace CleanArchitecture.Core.Mediator
{
    ...
    public class Mediator : IMediator
    {
        ...
        public async Task<TResult> SendAsync<TResult>(ICommand<TResult> command)
        {
            ...
            var method = handlerType.GetMethod("HandleAsync") ?? throw new InvalidOperationException($"Handler for command {commandType.Name} is missing HandleAsync method");
        ...
        public async Task<TResult> QueryAsync<TResult>(IQuery<TResult> query)
        {
            ...
            var method = handlerType.GetMethod("HandleAsync") ?? throw new InvalidOperationException($"Handler for query {queryType.Name} is missing HandleAsync method");
